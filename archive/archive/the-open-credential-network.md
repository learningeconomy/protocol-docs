...
Credential Networks implement a pluggable  [Verifiable Credentials (VCs)](https://www.w3.org/TR/vc-data-model/) and [Verifiable Presentation (VP)](https://www.w3.org/TR/vc-data-model/#dfn-verifiable-presentations) protocol (VCP) inline with [World Wide Web Consortium (W3C)](https://www.w3.org/) international standards to enable interoperable and portable exchange, storage, and programmability of credentials.
