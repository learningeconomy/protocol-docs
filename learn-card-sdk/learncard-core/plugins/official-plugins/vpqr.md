...
* Issuing a Verifiable Credential to a subject: for example, check out the [LearnCard Discord Bot](../../../../learncard-services/discord-bot.md), which sends a QR code as an attachment to an issued credential in a Discord message, allowing receivers to scan and claim the credential from any interoperable wallet.
* `//TODO: more examples`
...
For example, open up the [`learn-card-cli`](../../../../learncard-services/learncard-cli.md):thumbsup: and create a test Verifiable Presentation:
...
Open up the [`learn-card-cli`](../../../../learncard-services/learncard-cli.md) , and let's decode the Verifiable Presentation:
